...
ActiveRecord::Schema.define(version: 2017_08_07_034228) do

  create_table "captured_images", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.text "content", null: false
    t.integer "status", limit: 1, default: 0, null: false
    t.bigint "prototype_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["prototype_id"], name: "index_captured_images_on_prototype_id"
  end
